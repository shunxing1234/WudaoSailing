...
from nets.transformer import BaseTransformer
...
class BaseModel(torch.nn.Module):
    def __init__(self, args, transformer=None, parallel_output=True):
        ...
        self.mixins = torch.nn.ModuleDict()      # Initialize mixin which stores the optional operations
        self.collect_hooks_()                    # Initialize hooks which stores parameters from
