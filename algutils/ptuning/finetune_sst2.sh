...
CHECKPOINT_PATH=/data/wang/models/model_pretrained/
...
en_data="/data/wang/datasets/p_tuning_data/examples/glm/train.tsv"
eval_data="/data/wang/datasets/p_tuning_data/examples/glm/dev.tsv"
