...
OPTIONS_NCCL="NCCL_DEBUG=warn NCCL_IB_DISABLE=0 NCCL_NET_GDR_LEVEL=2"
HOST_FILE_PATH="hostfile"
HOST_FILE_PATH="/data/wang/glm/sat/cogview/config/coghostfile"

full_data="/dataset/fd5061f6/cogview/cogdata_new/cogdata_task_4leveltokens/merge.bin"
small_data="./16pic.bin.part_0.cogdata"
...
gpt_options=" \
       ...
       --img-tokenizer-path ./vqvae_hard_biggerset_011.pt \
