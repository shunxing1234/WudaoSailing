...
class GLMModel(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.word_embeddings = nets.VocabParallelEmbedding(
            vocab_size, hidden_size, init_method=init_method)

        # Transformer
        self.transformer = nets.GPT2ParallelTransformer(num_layers,
                                                       hidden_size,
                                                       num_attention_heads,
                                                       max_sequence_length,
                                                       max_memory_length,
...
class EncoderDecoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        # Transformer
        self.encoder = nets.GPT2ParallelTransformer(num_layers,
                                                   hidden_size,
                                                   num_attention_heads,
                                                   max_sequence_length,
                                                   max_memory_length,
                                                   ...
                                                   checkpoint_activations,
                                                   checkpoint_num_layers)
        self.decoder = nets.GPT2ParallelTransformer(num_layers,
                                                   hidden_size,
                                                   num_attention_heads,
                                                   max_sequence_length,
                                                   max_memory_length,
