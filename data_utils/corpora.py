...
class OpenWebText(PromptReader):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if torch.cuda.is_available():print_rank_0("Load language detection model")
    ...
    def print_info(self, info):
        ...
        while True:
            try:
                ...
                break
        if torch.cuda.is_available():print_rank_0(total_dict)
...
class WuDaoCorpus(PromptReader):
    ...
    PATH = "/data/wang/datasets/jinrongdata"
    is_json = False
    reserve_punct = True
    split_row = False
