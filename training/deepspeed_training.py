...
import mpu
from dataprocessing import cog_make_loaders
...
def training_main(args, model_cls, forward_step_function, create_dataset_function, init_function=None):
    ...
    # Data stuff.
    train_data, val_data, test_data = cog_make_loaders(args, hooks['create_dataset_function'])
...
def get_params_for_weight_decay_optimization(module):
    ...
    for module_ in module.modules():
        if isinstance(module_, (CogLayerNorm, torch.nn.LayerNorm)):
...
def initialize_distributed(args):
    ...
    print(args.world_size, args.rank, init_method)
